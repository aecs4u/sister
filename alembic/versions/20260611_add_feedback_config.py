...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("invitation_subject", sa.Text, nullable=False,
                  server_default="Il tuo feedback è importante"),
        ...
        sa.Column("invitation_cta_text", sa.Text, nullable=False,
                  server_default=_DEFAULT_CTA),
        ...
        sa.Column("invitation_unsub_text", sa.Text, nullable=False,
                  server_default=_DEFAULT_UNSUB),
        sa.Column("invitation_unsub_link_text", sa.Text, nullable=False,
                  server_default="Disiscriviti qui"),
